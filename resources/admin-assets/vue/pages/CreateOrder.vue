                ...
                <section class="col-lg-12" :class="{'loading-box': loading}">
                    ...
                    <div class="nav-tabs-custom" id="configuration">
                        <ul class="nav nav-tabs pull-right">
                            ...
                            <li :class="{'active': hasType('personal')}"><a href="#" @click.prevent="setType('personal')">პირადი</a></li>
                            <li :class="{'active': hasType('online')}"><a href="#" @click.prevent="setType('online')">ონლაინი</a></li>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <form class="form-horizontal" @submit.prevent="save" action="#" method="POST" style="margin: 20px 0">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <label>გადამხდელი&nbsp;&nbsp;&nbsp; <icheck type="radio" name="xero_invoice_for" v-model="mdl.xero_invoice_for" checked value="sender"></icheck></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
                                                <select-2 @change="fromChanged" style="width: 100% !important;" :options="{width: '100%', placeholder: 'Select country', minimumResultsForSearch: Infinity}" :disabled="senderExists" class="form-control" v-model.number="mdl.from_country_id">
                                                    <option value="">Clear</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <label>გადამხდელი&nbsp;&nbsp;&nbsp; <icheck type="radio"  name="xero_invoice_for" v-model="mdl.xero_invoice_for" value="receiver"></icheck></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <select-2 @change="toChanged" v-model.number="mdl.to_country_id"  :options="{width: '100%', placeholder: 'Select country', minimumResultsForSearch: Infinity}" :disabled="receiverExists" class="form-control">
                                                    <option value="">Clear</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <select-2 class="form-control" :options="{width: '100%', dropdownAutoWidth: true}" multiple @change="catsChanged">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <select-2 name="" v-model="mdl.obtain_currency" :options="{width: '100%', placeholder: 'Currency', minimumResultsForSearch: Infinity}" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <input v-model="mdl.weight" @keyup="weightChanged" class="form-control" placeholder="რეალური წონა">
                                            </div>
                                            ...
                                            <div class="col-sm-3" v-if="country_prices.from_home_per_kg">
                                                ...
                                                <label>სახლიდან წაღება &nbsp;&nbsp;<icheck @change="calcPrice" v-model="mdl.from_home_delivery" :true-value="1" :false-value="0"></icheck></label>
                                            </div>
                                            <div class="col-sm-3" v-if="country_prices.home_delivery || country_prices.home_delivery_per_kg">
                                                ...
                                                <label>სახლში მიტანა &nbsp;&nbsp;<icheck @change="calcPrice" v-model="mdl.home_delivery" :true-value="1" :false-value="0"></icheck></label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <form @submit.prevent="save" class="form-horizontal" action="#" method="POST" style="margin: 20px 0;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select-2 @change="fromChanged" class="form-control" :options="{width: '100%', placeholder: 'Select country', minimumResultsForSearch: Infinity}" v-model.number="mdl.from_country_id">
                                                    <option value="">Clear</option>
                                                    <option v-for="c in countries" :value="c.id">{{c.name}}</option>
                                                </select-2>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select-2 @change="calcPrice" :options="{width: '100%', placeholder: 'Select country', minimumResultsForSearch: Infinity}" v-model.number="mdl.to_country_id" class="form-control">
                                                    <option value="">Clear</option>
                                                    <option v-for="c in toCountries" :value="c.id">{{c.name}}</option>
                                                </select-2>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <input v-model.number="mdl.weight" @keyup="weightChanged" class="form-control" placeholder="რეალური წონა">
                                            </div>
                                            <div class="col-sm-2"></div>
                                            <div class="col-sm-2">
...
export default {
    ...
    beforeCreate() {
        ...
        Axios.all([countries(),parameters(),categories()])
            .then(Axios.spread((c, p, categories)=>{
                if(c.data.success) {
        ...
        save(cb) {
            ...
            if(this.type==='online') {
                axios.post("/order", _(this.mdl).pick(['tracking_number', 'room_number', 'weight', 'from_country_id', 'to_country_id']).omitBy(_(_.eq).partial('').value()).assign({parcel_type: this.type}))
                    .then(res => {
                        if (res.data.success) {
                            this.mdl = this.mdl_backup;
                            if (typeof cb === 'function') cb(res.data);
                            else {
                                toastr.success(res.data.result.text, "Kiwipost");
                            }
                        } else {
                ...
                let data = _(this.mdl).omit(['sender','receiver','tracking_number']).omitBy(_(_.eq).partial('').value()).assign({'parcel_type': this.type});
        ...
        calcPrice() {
            ...
            if (this.mdl.from_country_id && this.mdl.to_country_id && this.mdl.weight) {
                ...
                if (this.hasType('online')) {
                    ...
                    if (this.mdl.from_home_delivery) {
    ...
    mounted() {
        this.mdl_backup = _(this.mdl).cloneDeep();
        setTimeout(()=>{
            $(this.$el).find("input[type=checkbox]:not(.native),input[type=radio]:not(.native)").iCheck({
